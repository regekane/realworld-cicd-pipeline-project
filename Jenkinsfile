...
pipeline {
  ...
  -Dsonar.host.url=http://54.208.110.219:9000 \
  -Dsonar.login=85d2808a2fe6769bb9d2e615a3f1da6ef4ef543c
                """
                }
            }
        }
  ...
  post {
    always {
        ...
        slackSend channel: '#cicd-test-project', //update and provide your channel name
